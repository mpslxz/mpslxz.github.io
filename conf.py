...
SITE_URL = "https://mpslxz.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://mpslxz.github.io/"
BLOG_EMAIL = "n.tesla@example.com"
BLOG_DESCRIPTION = "Geeky experiences with computers, machine learning, programming, editors and other fun stuff."  # (translatable)
