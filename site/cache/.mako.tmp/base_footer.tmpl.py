...
_magic_number = 10
_modified_time = 1496709591.496093
_enable_loop = True
_template_filename = u'themes/canterville/templates/base_footer.tmpl'
...
def render_html_footer(context):
    ...
    try:
        ...
        __M_writer(u'\n')
        if content_footer:
            __M_writer(u'    <footer class="site-footer clearfix">\n        <section class="poweredby">')
...
"""
__M_BEGIN_METADATA
{"source_encoding": "utf-8", "line_map": {"33": 2, "34": 11, "40": 4, "48": 4, "49": 5, "50": 6, "51": 7, "52": 7, "53": 8, "54": 8, "23": 2, "26": 0, "60": 54}, "uri": "base_footer.tmpl", "filename": "themes/canterville/templates/base_footer.tmpl"}
__M_END_METADATA
"""
